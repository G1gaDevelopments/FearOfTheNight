...
execute as @s[scores={queen_atk=170}] if predicate fotn:rng/chance50 run say CHAAAAAAAAARGEEEEE
execute as @s[scores={queen_atk=150..170}] at @s run playsound minecraft:entity.enderman.teleport hostile @a
execute as @s[scores={queen_atk=150..170}] at @s anchored eyes rotated as @s run function fotn:impl/mobs/queen/bri_ish_charge
