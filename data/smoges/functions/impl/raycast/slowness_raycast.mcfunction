...
execute if entity @e[type=player,distance=0..3] run effect give @e[type=player,distance=0..3] slowness 20 10
execute if entity @e[type=player,distance=0..3] run effect give @e[type=player,distance=0..3] instant_damage 1 1
...
execute unless block ~ ~ ~ air at @s run effect give @e[type=player,distance=0..3] slowness 20 10
execute unless block ~ ~ ~ air at @s run effect give @e[type=player,distance=0..3] instant_damage 1 1
