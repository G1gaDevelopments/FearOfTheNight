...
execute as @e[type=armor_stand,tag=nt1_towerhere] at @s run setblock ~ ~ ~ structure_block[mode=load]{name:"smoges:nt_tower",posX:-5,posY:0,posZ:-5,rotation:"NONE",mirror:"NONE",mode:"LOAD"} destroy

# Random tower rotation
execute as @e[type=armor_stand,tag=nt1_towerhere] at @s run say test
execute as @e[type=armor_stand,tag=nt1_towerhere] at @s if predicate smoges:chance10 run data merge block ~ ~ ~ {mirror:"FRONT_BACK"}
execute as @e[type=armor_stand,tag=nt1_towerhere] at @s if predicate smoges:chance10 run data merge block ~ ~ ~ {mirror:"LEFT_RIGHT"}
...
execute at @e[type=armor_stand,tag=nt1_spawnhere] run function smoges:spawn/mob/commander_nocturnus
execute at @e[type=armor_stand,tag=nt1_spawnhere] run function smoges:spawn/mob/commander_nocturnus
execute at @e[type=armor_stand,tag=nt1_spawnhere] run function smoges:spawn/mob/commander_nocturnus
execute at @e[type=armor_stand,tag=nt1_spawnhere] run function smoges:spawn/mob/commander_nocturnus
execute at @e[type=armor_stand,tag=nt1_spawnhere] run function smoges:spawn/mob/commander_nocturnus

execute at @e[type=armor_stand,tag=nt1_spawnhere] run function smoges:spawn/mob/nocturnus_boss_phase1
