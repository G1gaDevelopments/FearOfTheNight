...
execute as @e[type=player,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:6164006}}},scores={qst_cooldown=..0}] at @s run title @s actionbar ["",{"text":"Right click to shoot ","color":"gold"},{"text":" | ","color":"magenta"},{"text":"Uses: ","color":"aqua"},{"score":{"name":"@s","objective":"qst_uses"},"color":"aqua"},{"text":" | ","color":"magenta"},{"text":"Ready!","color":"green"}]

# Egg Launcher
execute as @e[type=player,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:6164016}}},scores={egl_cooldown=1..}] at @s run title @s actionbar ["",{"text":"Right click to use, refill with totems ","color":"gold"},{"text":" | ","color":"magenta"},{"text":"Ammo: ","color":"aqua"},{"score":{"name":"@s","objective":"egl_ammo"},"color":"aqua"},{"text":" | ","color":"magenta"},{"text":"Cooldown: ","color":"red"},{"score":{"name":"@s","objective":"egl_cooldown"},"color":"red"}]

execute as @e[type=player,nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{CustomModelData:6164016}}},scores={egl_cooldown=..0}] at @s run title @s actionbar ["",{"text":"Right click to shoot ","color":"gold"},{"text":" | ","color":"magenta"},{"text":"Ammo: ","color":"aqua"},{"score":{"name":"@s","objective":"egl_ammo"},"color":"aqua"},{"text":" | ","color":"magenta"},{"text":"Ready!","color":"green"}]