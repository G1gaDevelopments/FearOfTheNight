...
execute if entity @e[type=player,distance=0..3] run effect give @e[type=player,distance=0..3] slowness 1 10
...
execute unless block ~ ~ ~ air at @s run effect give @e[type=player,distance=0..3] slowness 1 10
