...
kill @e[type=item,nbt={Item:{id:"minecraft:quartz",tag:{FotnID:13},Count:1b},OnGround:1b},distance=..2,limit=1,sort=nearest]
...
execute at @e[type=armor_stand,tag=lv_spawnhere,sort=nearest,limit=1] run function fotn:spawn/mob/leviathan_boss
