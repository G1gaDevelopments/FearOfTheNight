...
execute as @e[tag=replace_with_bull] as @s run summon cow ~ ~ ~ {CustomNameVisible:1b,Health:13f,Tags:["scanned","is_bull"],CustomName:'{"text":"Bull"}',Attributes:[{Name:"generic.max_health",Base:13},{Name:"generic.knockback_resistance",Base:0.2},{Name:"generic.movement_speed",Base:0.5}]}
