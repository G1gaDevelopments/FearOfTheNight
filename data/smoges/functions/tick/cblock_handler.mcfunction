...
execute as @e[type=glow_item_frame,tag=eg_spawner,tag=!cblock_placed] at @s run function smoges:impl/cblock/egglord_spawner/place
...
execute as @e[type=glow_item_frame,tag=eg_spawner,tag=cblock_placed] at @s unless block ~ ~ ~ bedrock run function smoges:impl/cblock/egglord_spawner/remove